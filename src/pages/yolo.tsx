...
const Yolo = ({ suit, _setPoints, setOpenYolo }) => {
    const webcam = new Webcam(); // webcam handler
    const adut = suit.value;
    ...
    return (
        <div className="App">
            ...
            <div onClick={() => {
                ...
                <ButtonHandler points={points} _setPoints={_setPoints} setOpenYolo={setOpenYolo} cameraRef={cameraRef} streaming={streaming} setStreaming={setStreaming} isTorchSupported={(value: boolean) => { setTorchSupported(value) }} />
            </div>
